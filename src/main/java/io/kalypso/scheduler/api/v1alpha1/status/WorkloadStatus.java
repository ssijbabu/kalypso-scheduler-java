...
/**
 * Observed state of a {@code Workload} resource.
 *
 * <p>The {@code WorkloadReconciler} writes a {@code Ready} condition after each
 * reconciliation cycle:
 * <ul>
 *   <li>{@code Ready=True} — all {@code DeploymentTarget} CRDs are in sync with
 *       the workload's {@code spec.deploymentTargets}.</li>
