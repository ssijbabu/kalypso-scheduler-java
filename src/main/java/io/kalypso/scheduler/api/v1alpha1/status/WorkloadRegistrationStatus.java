...
/**
 * Observed state of a {@code WorkloadRegistration} resource.
 *
 * <p>The {@code WorkloadRegistrationReconciler} writes a {@code Ready} condition
 * after each reconciliation cycle:
 * <ul>
 *   <li>{@code Ready=True} — Flux resources were created or verified successfully.</li>
 *   <li>{@code Ready=False} — An error occurred; the resource will be requeued.</li>
 * </ul>
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class WorkloadRegistrationStatus {
