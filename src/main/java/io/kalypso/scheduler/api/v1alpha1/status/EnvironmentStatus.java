...
/**
 * Observed state of an {@code Environment} resource.
 *
 * <p>The {@code EnvironmentReconciler} writes a {@code Ready} condition after each
 * reconciliation cycle:
 * <ul>
 *   <li>{@code Ready=True} — Flux resources for the environment were created or verified.</li>
 *   <li>{@code Ready=False} — An error occurred; the {@code message} field contains
 *       the reason and the resource will be requeued.</li>
 * </ul>
 */
